...
import com.example.pfenningvaadin2022mysql3.service.StoppService;
...
@PageTitle("MStopp")
//@RolesAllowed("USER")
public class MStopp extends VerticalLayout {
    ...
    public MStopp(StoppService stoppService, MarktService marktService, TourService tourService){
