...
public class ArbeitTagForm extends FormLayout {
    ...
    ComboBox<Fahrer> fahrerName =new ComboBox("fahrer name");
    //TextField fahrer_id = new TextField("fahrer id");


    DatePicker arbeitbeginDate = new DatePicker("arbeitbegin");
    TimePicker arbeitbeginZeit = new TimePicker();
    TimePicker arbeitendeZeit = new TimePicker();
   ...
   Binder<ArbeitTag> binder = new BeanValidationBinder<>(ArbeitTag.class);
    ...
    public ArbeitTagForm(List<Fahrer>fahrerList) {
        ...
        fahrerName.setItems(fahrerList);
        fahrerName.setItemLabelGenerator(Fahrer::getName);

        arbeitbeginZeit.setLabel("arbeitbeginn zeit");
        arbeitbeginZeit.setStep(Duration.ofMinutes(15));

        arbeitendeZeit.setLabel("arbeitende zeit");
        arbeitendeZeit.setStep(Duration.ofMinutes(15));
