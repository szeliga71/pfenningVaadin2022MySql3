...
public class ArbeitTagList extends VerticalLayout {
    ...
    private void configureGrid() {
        ...
        grid.setColumns("fahrerName","arbeitbeginDate","arbeitbeginZeit","arbeitendeZeit","kilometer","fahrerbruch","unfall","pause");
    ...
    private void configureArbeitTagForm() {
        arbeitTagForm = new ArbeitTagForm(fahrerService.getAllFahrer());//,arbeitTagService.findAllArbeitTaggs());
