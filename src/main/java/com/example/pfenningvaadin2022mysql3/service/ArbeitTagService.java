...
import com.example.pfenningvaadin2022mysql3.repository.ArebeitTagRepository;
...
public class ArbeitTagService {
    ...
    public List<ArbeitTag> getArbeitTagByMaxIdName(String namee) {
        return arbeitTagRepository.getArbeitTagByMaxIdName(namee);
    }
}
